let handler = async(m, { conn, usedPrefix, command, text }) => {
      ...
      tekse = text.split('|')[1];
      juml = text.split('|')[2];
      if (!nomt) throw `Example ${usedPrefix + command} 6281234567890|Teks|1`
      if (!tekse) throw `Example ${usedPrefix + command} 6281234567890|Teks|1`
      if (!juml) throw `Example ${usedPrefix + command} 6281234567890|Teks|1`
