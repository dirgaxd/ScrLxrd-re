...
let handler = async(m, { isOwner, isAdmin, conn, text, participants }) => {
  ...
  conn.relayMessage(m.chat, { requestPaymentMessage: { Message: { TextMessage: { text: teks, currencyCodeIso4217: 'IDR', requestFrom: '6283821123163@s.whatsapp.net', expiryTimestamp: 6283821123163, amount: 6283821123163, background: fs.readFileSync('./src/logo.jpg') }}}}, {})
